...
@(request-snippet struct-declaration typed-id)
...
@(request-snippet pragma-form version-expr version-expr0 version-term version-atom)
...
@(request-snippet import-form import-selection import-element import-name import-prefix)
...
@(request-snippet witness-declaration simple-parameter-list typed-id)
...
@(request-snippet constructor-definition pattern-parameter-list typed-pattern)
...
@(request-snippet circuit-definition pattern-parameter-list typed-pattern)
...
@(request-snippet cbinding optionally-typed-pattern pattern-struct-elt)
...
@(request-snippet expr-seq expr expr0 expr1 expr2 expr3 expr4 expr5 expr6 expr7 expr8 expr9 tuple-arg bytes-arg struct-arg term)
...
@(request-snippet fun arrow-parameter-list optionally-typed-pattern pattern pattern-struct-elt return-type)
